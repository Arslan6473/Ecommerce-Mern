...
function Footer() {
    return (
        <div className='mb-0'>
            <section class="py-6 bg-gray-800 mb-0 text-gray-200">
                <div class="container mx-auto flex flex-col justify-around  p-4 text-center md:p-10 lg:flex-row">
                    <div class="flex flex-col justify-center lg:text-left">
                        <p class="mb-1 text-sm font-medium tracking-widest uppercase text-gray-600">Buy your favourite products
                        </p>
                        <h1 class="py-2 text-3xl font-medium leading-tight title-font">Download our app </h1>
                    </div>
                    <div
